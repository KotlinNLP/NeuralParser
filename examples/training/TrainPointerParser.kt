...
import com.kotlinnlp.neuralparser.parsers.pointerparser.PointerParserTrainer
...
fun main(args: Array<String>) = mainBody {
  ...
  val parser: PointerParser = buildParser(
...
private fun buildParser(
...
): PointerParser = PointerParser(model = PointerParserModel(
  ...
  grammaticalConfigurations = corpus.grammaticalConfigurations))
...
/**
 * Build a trainer for a given [PointerParser].
 *
 ...
 */
private fun buildTrainer(parser: PointerParser,
                         parsedArgs: CommandLineArguments): PointerParserTrainer {

  val preprocessor: SentencePreprocessor = BasePreprocessor()

  return PointerParserTrainer(
    parser = parser,
