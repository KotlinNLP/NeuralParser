...
/**
 * The ArcStandard Attention Single Prediction ActionsScorer.
 *
 ...
 */
class ArcStandardAttentionSPActionsScorer<in SupportStructureType : SPSupportStructure>(
    ...
    SupportStructureType>(network, optimizer, deprelTags)
{
  ...
  override val Transition<ArcStandardTransition, StackBufferState>.Action.outcomeIndex: Int get() = when {
    ...
    this is DependencyRelation -> this@ArcStandardAttentionSPActionsScorer.deprelTags.getId(this.deprel!!)!! + 1 // + shift offset
