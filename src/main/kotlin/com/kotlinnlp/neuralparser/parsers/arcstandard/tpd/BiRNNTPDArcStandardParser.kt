...
import com.kotlinnlp.neuralparser.templates.supportstructure.compositeprediction.TPDStructureFactory
...
/**
 * A NeuralParser based on the ArcStandard transition system that uses Embeddings and ambiguous POS vectors to encode
 * the tokens of a sentence through a BiRNN.
 *
