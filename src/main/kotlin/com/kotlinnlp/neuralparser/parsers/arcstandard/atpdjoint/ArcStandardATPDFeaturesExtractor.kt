 ...
 *
 * @param actionsEmbeddings the embeddings vectors of the actions
 * @param actionsEmbeddingsOptimizer the optimizer of the [actionsEmbeddings]
 * @param actionsEncodingSize the size of the actions encoding vectors
...
class ArcStandardATPDFeaturesExtractor(
  private val actionsEmbeddings: ActionsEmbeddingsMap,
  private val actionsEmbeddingsOptimizer: ActionsEmbeddingsOptimizer,
  ...
  override fun extract(
    ...
    return DenseFeatures(array = concatVectorsV(
      supportStructure.actionProcessor.forward(
        featuresArray = lastAppliedActionEmbedding.array.values,
  ...
  private fun accumulateActionEmbeddingErrors(errors: DenseNDArray, actionIndex: Int) {
    ...
    if (actionIndex == 0) {
      this.actionsEmbeddingsOptimizer.accumulateNullEmbeddingsErrors(errors)

    } else {
      val action = this.appliedActions[actionIndex]!!
      this.actionsEmbeddingsOptimizer.accumulate(
