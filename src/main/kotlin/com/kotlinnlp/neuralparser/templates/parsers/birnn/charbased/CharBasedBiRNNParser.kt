...
package com.kotlinnlp.neuralparser.templates.parsers.birnn.charbased
...
/**
 * A [NeuralParser] that uses Embeddings encoded with a BiRNN to encode the tokens of a sentence.
 *
